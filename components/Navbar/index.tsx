...
function NavBar() {
  ...
  return (
    <div className="text-sub bg-backgroud h-[4.5rem] w-full backdrop-blur-md">
      <div className="mx-auto flex h-full justify-between p-sec">
        ...
        <div className="flex items-center justify-center gap-2">
          <div className="relative flex size-10 sm:size-12 items-center justify-center rounded-full bg-[#F6F6FD]">
            <svg
              width="24"
              height="25"
              viewBox="0 0 24 25"
            ...
            <span className="absolute size-4 top-2 end-2 border-2 border-backgroud rounded-full bg-primary text-center font-semibold text-[8px] text-white">2</span>

          </div>
          <div className="relative flex size-10 sm:size-12  items-center justify-center pt-1 rounded-full bg-[#F6F6FD]">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
          ...
          {loggedIn ? (
              <>
          <div className="flex size-10 sm:size-12  items-center justify-center rounded-full bg-[#F6F6FD]">
            <svg
              width="24"
              height="25"
          ...
          <div className="hidden sm:flex items-center justify-center gap-2">
                ...
                <Image
                  ...
                  src={profile}
                  alt="profile image"
                  className="hidden sm:block size-10 rounded-full"
                />

                <div>
                  <h3 className="text-text">Amr Zain</h3>
